// javascript to display images and thumbnails
...
tempImg.onload = function(){
	currentImage.src = "gallery/images/image" + pad (startwith,4) + ".jpg";
	currentImage.alt = "Gallery Image " + pad (startwith,4);
	appendImage();
}

let tryLoadImage = function(){
	tempImg.src = "gallery/thumbnails/image" + pad(i, 4) + ".jpg";
}
...
function plusSlides(y) {
	...
	currentImage.src = "gallery/images/image" + pad(startwith,4) + ".jpg";
	currentImage.alt = "Image Gallery Image" + pad(startwith,4);
}
